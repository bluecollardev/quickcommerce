...
// Configuration
if (is_file(__DIR__.'/vendor/opencart/upload/config.php')) {
	require_once(__DIR__.'/vendor/opencart/upload/config.php');
}
...
// VirtualQMOD
require_once(__DIR__.'/vendor/opencart/upload/vqmod/vqmod.php');
VQMod::bootup();
